...
<MapPin size={16} className="mr-1 flex-shrink-0 text-primary" aria-hidden="true" />
...
<Users size={14} className="mr-1 text-primary" aria-hidden="true" />
...
<Clock size={12} className="mr-1 text-primary" aria-hidden="true" />
Open today: {openingHours[new Date().getDay() === 0 ? 6 : new Date().getDay() - 1].hours}
</div>

<div className="bg-muted px-3 py-1 rounded-full flex items-center text-xs text-card-foreground">
<Calendar size={12} className="mr-1 text-primary" aria-hidden="true" />
Founded: {foundingDate}
</div>

<div className="bg-muted px-3 py-1 rounded-full flex items-center text-xs text-card-foreground">
<Building size={12} className="mr-1 text-primary" aria-hidden="true" />
