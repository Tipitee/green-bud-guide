...
<div className="mb-4">
<Button variant="ghost" onClick={handleBackClick} className="inline-flex items-center font-medium text-foreground hover:bg-accent/20" aria-label="Back to clubs">
...
<Info className="h-4 w-4 text-info-icon" aria-hidden="true" />
...
<Leaf size={16} className="mr-2" aria-hidden="true" />
Strains
</TabsTrigger>
...
<TabsContent value="info" className="mt-0 rounded-lg p-6 shadow-md border border-border bg-card">
