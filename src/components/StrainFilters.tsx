...
return <div className="bg-card p-4 rounded-lg border border-border shadow-sm">
<div className="flex justify-between items-center mb-4">
<h3 className="font-semibold text-card-foreground">{t('filters.filter')}</h3>
...
<Button onClick={applyFilters} variant="filter" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground">
